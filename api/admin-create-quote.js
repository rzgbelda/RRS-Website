...
module.exports = async (req, res) => {
  ...
  const quoteData = {
    ...
    shipping_street:  (b.shipping_street || '').trim() || null,
    shipping_city:    (b.shipping_city || '').trim() || null,
    shipping_state:   (b.shipping_state || '').trim() || null,
    shipping_zip:     (b.shipping_zip || '').trim() || null,
    notes:            (b.notes || '').trim(),
    requested_items:  [],
    status:           'new',
