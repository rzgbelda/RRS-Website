    ...
    <main className="dashboard-content">
      ...
      {showForm && (
        <div className="form-section-card" style={{ marginBottom: "24px" }}>
          ...
          <button onClick={handleAdd} className="submit-btn" style={{ marginTop: "16px" }}>Save Product</button>
        </div>
      )}
      ...
      <div className="data-table">
        ...
        <table>
          <thead>
            <tr>
              <th>Product Name</th><th>Category</th><th>Pack Size</th><th>Case Qty</th><th>Price/Case</th><th>Stock</th><th>Actions</th>
            </tr>
          </thead>
          <tbody>
            {products.map((p) => (
