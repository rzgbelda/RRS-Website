    ...
    <main className="dashboard-content">
      ...
      <div className="data-table">
        ...
        <table>
          <thead>
            <tr>
              <th>ID</th><th>Business</th><th>Type</th><th>Contact</th><th>Email</th>
              <th>Phone</th><th>Orders</th><th>Reorders</th><th>Total Spend</th><th>Actions</th>
            </tr>
          </thead>
          <tbody>
            {CUSTOMERS.map((c) => (
              <tr key={c.id}>
                ...
                <td>
                  <button style={{ background: "#dbeafe", color: "#1e40af", border: "none", borderRadius: "4px", padding: "6px 10px", fontSize: "12px", cursor: "pointer" }}>
                    View
                  </button>
                </td>
              </tr>
